...
BASE_DIR = os.path.abspath(os.path.dirname(__file__))  # Ensures correct directory
UPLOAD_FOLDER = os.path.join(BASE_DIR, "uploads")  # Store uploads here
...
async def transcribe_audio(file: UploadFile = File(...)):
    ...
    try:
        ...
        # Convert WebM to WAV if needed, ensuring FFmpeg exists
